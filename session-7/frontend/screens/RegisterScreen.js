...
export default function RegisterScreen({ navigation }) {
    ...
    async function handleSignUp() {
        ...
        if (!isPasswordValid(password)) {
            alert("Password must be at least 8 characters long and have at least one uppercase letter and special character.");
            return;
        }
    ...
    return (
        <View style={styles.container}>
            <View style={styles.content}>
                ...
                <Text style={styles.smallGreyText}> Already have an account? <Text style={styles.smallWhiteText} onPress={() => navigation.navigate('Login')}> Sign in </Text> </Text>
            </View>
        </View>
    );
}
